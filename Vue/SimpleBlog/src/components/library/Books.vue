...
<script>
import EditForm from './EditLibraryForm.vue'
import SearchBar from './SearchLibraryBar.vue'
export default {
  name: 'Books',
  components: {
    EditForm,
  ...
  mounted: function () { // 页面初始化后调用的钩子函数
    this.loadBooks()
  },
  methods: {
    loadBooks () {
